...
import pandas as pd
import preprocessing,statistical_analysis
...
if user_menu == 'Medal Tally':
    ...
    years,country = statistical_analysis.country_year_list(df)
...
if user_menu == 'Overall Analysis':
    ...
    nations_over_time = statistical_analysis.data_over_time(df)
