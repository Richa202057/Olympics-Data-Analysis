# Exploratory Data Analysis: 120 Years of Olympics History including Python <a href="https://richa202057-olympics-data-analysis-app-nxrl6a.streamlit.app/" target="_blank">Web App</a>
# Introduction
...
# Python Web App
This project is deployed on Streamlit Community Cloud. You can access the web app <a href="https://richa202057-olympics-data-analysis-app-nxrl6a.streamlit.app/"><strong>here</strong></a>. <br> **Note:** All the graphs and charts are interactive. You can hover over the graphs and charts to get more information. You can also download the graphs and charts in png format.
